...
static PyObject * cobj_in(PyObject * self, PyObject * args)
{
  ...
  my_struct * x = malloc(sizeof(my_struct));
...
static PyObject * complex_return_type2(PyObject * self, PyObject * args)
{
  int key_1 = 5;
  int key_2 = 6;
  char * key_3 = "this is my key";

  char * value_1 = "this is value 1";
  char * value_2 = "this is another value";
  char * value_3 = "this is my final value";
